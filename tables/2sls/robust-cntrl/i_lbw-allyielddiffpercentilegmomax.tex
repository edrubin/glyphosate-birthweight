\begin{table}[htbp]
   ...
   \begin{threeparttable}[b]
      \caption{\label{tab:robust-cntrl-i_lbw-allyielddiffpercentilegmomax} \textbf{The effect of glyphosate on probability of low birthweight, \\ Robustness to alternative controls and fixed effects}}
