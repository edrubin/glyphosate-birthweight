\begin{table}[htbp]
   ...
   \begin{threeparttable}[b]
      \caption{\label{tab:robust-cntrl-dbwt_pred-e100myielddiffpercentilegmo} \textbf{The effect of glyphosate on predicted birthweight, \\ Robustness to alternative controls and fixed effects}}
