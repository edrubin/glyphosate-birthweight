\begin{table}[htbp]
   ...
   \begin{threeparttable}[b]
      \caption{\label{tab:robust-cntrl-dbwt_pred-allyielddiffpercentilegmo} \textbf{The effect of glyphosate on predicted birthweight, \\ Robustness to alternative controls and fixed effects}}
