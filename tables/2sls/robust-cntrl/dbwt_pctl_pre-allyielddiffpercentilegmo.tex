\begin{table}[htbp]
   ...
   \begin{threeparttable}[b]
      \caption{\label{tab:robust-cntrl-dbwt_pctl_pre-allyielddiffpercentilegmo} \textbf{The effect of glyphosate on birthweight percentile, \\ Robustness to alternative controls and fixed effects}}
